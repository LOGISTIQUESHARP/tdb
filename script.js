...
var options = {
  ...
  xaxis: {
    categories: ['juillet', 'aout', 'septembre', 'octobre', 'novembre','decembre', 'janvier', 'fevrier','mars','avril', 'mai', 'juin'],
  },
  yaxis: {
    title: {
        text: 'quantité',
...
/*graph livraisons*/ 
  ...
  var mixedoptions = {
    ...
    name: 'TOTAL',
    type: 'column',
    data: [610, 646, 852,681]
  }, {
    name: 'Nouméa',
    type: 'line',
    data: [297,	216, 379, 280]
  }, {
    name: 'Grand nouméa',
    type: 'line',
    data: [313, 394, 334, 272]
  }, {
    name: 'ADV',
    type: 'line',
     data: [0, 36, 139, 129]
